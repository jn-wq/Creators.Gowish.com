    ...
    <section className="mx-auto max-w-[1180px] px-6 py-20">
      <div className="relative overflow-hidden rounded-3xl bg-ink text-bg p-12 md:p-20">
        ...
        <div className="relative max-w-2xl">
          <p className="eyebrow !text-accent">05 — Bliv creator</p>
          ...
          <p className="mt-6 text-[19px] text-bg/75 leading-[1.45] max-w-[50ch]">
            Slut dig til 950+ creators der forvandler anbefalinger til permanente
            udbetalinger. Beta-adgang er åben — ingen venteliste.
          </p>
          <div className="mt-8 flex flex-wrap gap-3">
            <a href="#" className="btn-accent">
              Opret min konto <ArrowRight className="h-4 w-4" />
            </a>
            <a
              href="/learning-bank"
              className="btn-ghost !border-bg/20 !text-bg hover:!bg-bg/10"
            >
              Udforsk Learning Bank
            </a>
          </div>
        </div>
      </div>
